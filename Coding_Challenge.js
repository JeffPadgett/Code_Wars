...
HINT: Use some of the es6 features: classes, subclasses, tempalte strings, default parameters, maps, 
arrow functions, destructuring, ect. 
*/

class Element {
    constructor(name, buildYear) {
        this.name = name;
        this.buildYeare = buildYear;
    }
}
...
const allStreets = [new Street('Ocean Avenue', 1987, 1.1, 4), new Street('Evergreen Street', 2008, 2.7, 2), new Street('4th Street', 2015, 0.8), new Street('Sunset Boulevard', 1982, 2.5, 5)];
